...
public class TopSortTest1 {
    ...
    public void testDFS1() {
        ...
        ArrayList<String> expected = new ArrayList<String>(
                Arrays.asList("c2", "c1", "c3", "c4", "c5"));
        assertEquals("dfs should be c2, c1, c3, c4, c5", expected, actual);
    }

    @Test
    public void testDFS2() {
        String[][] graphin = { { "c1", "c3" }, { "c3", "c4", "c5" },
                { "c4", "c5" }, { "c5" } };
        Graph g = new Graph(graphin);
        TopSort t = new TopSort();
        ArrayList<String> actual = t.dfsTopSort(g);
        ArrayList<String> expected = new ArrayList<String>(
                Arrays.asList("c1", "c3", "c4", "c5"));
    ...
    public void testDFS3() {
        ...
        assertEquals("dfs should be null; graph has a cycle", expected,
                actual);
    }
    ...
    public void testDFS4() {
        String[][] graphin = { { "c1", "c3" }, { "c2", "c3" },
                { "c3", "c4", "c5" }, { "c4", "c5" }, { "c5" }, { "c6", "c7" },
                { "c7" } };
        Graph g = new Graph(graphin);
        TopSort t = new TopSort();
        ArrayList<String> actual = t.dfsTopSort(g);
        ArrayList<String> expected = new ArrayList<String>(
                Arrays.asList("c6", "c7", "c2", "c1", "c3", "c4", "c5"));
        assertEquals("dfs should be c6, c7, c2, c1, c3, c4, c5", expected,
                actual);
    }
    ...
    public void testSource3() {
        ...
        ArrayList<String> actual = t.sourceTopSort(g);
        ArrayList<String> expected = null;
        assertEquals("source should be null; graph has a cycle", expected,
                actual);
    }
    ...
    public void testSource4() {
        ...
        ArrayList<String> actual = t.sourceTopSort(g);
        ArrayList<String> expected = new ArrayList<String>(
                Arrays.asList("c1", "c2", "c3", "c4", "c5", "c6", "c7"));
        assertEquals("source should be c1, c2, c3, c4, c5, c6, c7", expected,
                actual);
    }
