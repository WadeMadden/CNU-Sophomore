...
public class ColoredSquare implements Cloneable {
    ...
    private final static Color[] COLORS = { Color.DARK_GRAY, Color.BLACK,
            Color.BLUE, Color.CYAN, Color.GRAY, Color.GREEN, Color.LIGHT_GRAY,
    ...
    public boolean equals(Object obj) {
        if (obj != null) {
            ...
            if (getClass() == obj.getClass()) {
                ...
                if (color == other.color && square.equals(other.square)) {
                    return true;
                }
            }
        }
